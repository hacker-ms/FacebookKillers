...
echo $i" |"$cy"     Pakhtoon Cyber Army "$i"         |"
echo $i" |"$me"─────────────────────────────────────────────"$i"|"
echo $i" |"$pu" AUTHOR :"$ku" Muzakkir Shah With Dear [Ali]"$i"          |"
echo $i" |"$pu" FACEBOOK :"$ku" Muzakkir Roya "$i"                   |"
echo $i" |"$pu" THANKS TO :"$cy"~ [Ali] [NLCS] [Gang Hackers] "$i"  |"
echo $i" |"$cy"            ~ [Muzakkir] [Ali] [Lover of Hacking]"$i" |"
echo $i" |"$pu" Contact me on  WhatsApp :"$ku" +923491986759 "$i"             |"
echo $i" |"$pu" Contact me on Gmail :"$ku" Muzakkirshahvip@gmail.com "$i"      |"
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo
echo $i"────────────────────────────────    ─────"
echo $i"|"$me" 1"$i" |"$cy" BRUTEFORCE FB PHP        "$i"|"$i"    |"$cy" B"$i" |"
echo $i"|"$me" 2"$i" |"$cy" BRUTEFORCE FB BR1G4D3    "$i"|"$i"    |"$cy" R"$i" |"
echo $i"|"$me" 3"$i" |"$cy" BRUTEFORCE FB iqbalz     "$i"|"$i"    |"$cy" U"$i" |"
echo $i"|"$me" 4"$i" |"$cy" BRUTEFORCE FB MBF        "$i"|"$i"    |"$cy" T"$i" |"
echo $i"|"$me" 5"$i" |"$cy" FACEBRUTE N1ght420       "$i"|"$i"    |"$cy" E"$i" |"
echo $i"|"$me" 6"$i" |"$cy" BRUTEFORCE FB ( root )   "$i"|"$i"    |"$cy" F"$i" |"
echo $i"────────────────────────────────"$i"    |"$cy" L"$i" |"
...
echo $i"|"$me"17"$i" |"$cy" PHISING FACEBOOK 4       "$i"|"$i"    |"$cy" I"$i" |"
echo $i"────────────────────────────────"$i"    |"$cy" R"$i" |"
echo $i"|"$me"18"$i" |"$cy" INSTALL BAHAN DULU COEG  "$i"|"$i"    |"$cy" E"$i" |"
echo $i"|"$me"19"$i" |"$cy" KELUAR/EXIT PROGRAM      "$i"|"$i"    |"$cy" S"$i" |"
echo $i"────────────────────────────────    ─────"
echo
echo $me"┌==="$bi"["$i"Muzakkir Shah"$bi"]"$me"======"$bi"["$i""My Lover SAYBA""$bi"]"
echo $me"¦"
read -p"└──# " pil
...
sleep 2
echo $cy"We Are Not Responsible For Illegal Use "
sleep 2
echo $i"If You Love us Please SUBSCRIBE Us"
sleep 2
echo $ku"WhatsApp :"$i" +923491986759"
echo $ku"Facebook :"$i" Muzakkir Shah and With Dear [Ali] a Best Friend"
sleep 2
echo $pur">> Thanks Support me and Give Me SUBSCRIBE<<"
exit
fi